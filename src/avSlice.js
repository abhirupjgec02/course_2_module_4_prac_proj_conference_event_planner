...
export const avSlice = createSlice({
  ...
  initialState: [
    ...
    {
        img: "https://media.istockphoto.com/id/924425774/photo/retro-vintage-microphone-on-yellow-background-studio.jpg?s=2048x2048&w=is&k=20&c=zMDufK1XHmscOmC5ozk_jSHZzq7ziQDere920qzkCVM=",
        name: "Microphones",
        cost: 45,
        quantity: 0,
    },
